...
def test_annual_climatology_for_regions_uses_calendar_day_weighting():
    """
    Verifica se a média anual utiliza corretamente o número real de
    dias representado por cada mês durante o período 1981-2010.

    Apenas fevereiro possui valor diferente de zero, permitindo
    verificar diretamente o peso temporal aplicado.
    """
    ...
    # 1981-2010 contém 847 dias de fevereiro, 10 957 dias no total.
